    ...
    <View className="flex-1 relative h-full w-full">
      ...
      {loading ? (
        ...
        <SafeAreaView className="flex flex-1">
          ...
          {/* Forecast Section  */}
          <View className="flex flex-1 justify-around mb-1 mx-4">
            {/* Location */}
            ...
            <View>
              ...
              <Text className="text-center pt-1 text-white text-2xl tracking-widest">
            ...
            <View className="gap-y-4">
              ...
              <View className="flex-row justify-center gap-x-6">
                <View className="flex-row items-center">
                  <Text className="text-white font-semibold text-base pl-3 ">
                    Air Quality : {current?.air_quality?.co} CO
                  </Text>
                </View>
                <View className="flex-row  items-center">
                  <Text className="text-white font-semibold text-base pl-3">
          ...
          <View className="mb-12">
            <View className="flex-row items-center mx-5 space-x-2 pb-6">
              ...
              <Text className="text-white font-semibold"> Daily Forecast</Text>
            </View>
            <ScrollView
              horizontal
            ...
            >
              {weather?.forecast?.forecastday.map((day, index) => {
                ...
                return (
                  <View
                    key={index}
                    className="flex justify-center items-center w-24 rounded-3xl py-3 mr-4 gap-y-2"
                  ...
                  >
                    ...
                    <Text className="text-white text-xl font-semibold flex gap-x-4">
                      <Image
                        source={require("../../assets/icons/drop.png")}
                        className="h-3 w-3"
                      />
